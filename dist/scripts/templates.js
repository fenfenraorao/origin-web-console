angular.module('openshiftConsoleTemplates', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/_alerts.html',
    ...
    "<div class=\"alert word-break\" ng-class=\"{\r" +
    "\n" +
    "      'alert-danger': alert.type === 'error',\r" +
    "\n" +
    "      'alert-warning': alert.type === 'warning',\r" +
    "\n" +
    "      'alert-success': alert.type === 'success',\r" +
    "\n" +
    "      'alert-info': !alert.type || alert.type === 'info',\r" +
    "\n" +
    "      'toast-pf': toast,\r" +
    "\n" +
    "      'mar-left-sm': toast\r" +
    ...
    "</button>\n" +
    "<span class=\"pficon\" aria-hidden=\"true\" ng-class=\"{\r" +
    "\n" +
    "        'pficon-error-circle-o': alert.type === 'error',\r" +
    "\n" +
    "        'pficon-warning-triangle-o': alert.type === 'warning',\r" +
    "\n" +
    "        'pficon-ok': alert.type === 'success',\r" +
    "\n" +
    "        'pficon-info': !alert.type || alert.type === 'info'\r" +
    "\n" +
    "      }\"></span>\n" +
  ...
  $templateCache.put('views/directives/osc-file-input.html',
    ...
    "</div>\n" +
    "<textarea class=\"form-control\" rows=\"5\" ng-show=\"showTextArea || !supportsFileUpload\" ng-model=\"model\" ng-required=\"required\" ng-disabled=\"disabled\" ng-readonly=\"readonly\" autocorrect=\"off\" autocapitalize=\"none\" spellcheck=\"false\" ng-attr-aria-describedby=\"{{helpText ? helpID : undefined}}\">\r" +
    "\n" +
    "  </textarea>\n" +
